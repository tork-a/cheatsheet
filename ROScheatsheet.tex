...
\usepackage[landscape,paperwidth=297mm,paperheight=210mm]{geometry}
\usepackage{hyperref}
\usepackage{setspace}
...
\ifthenelse{\lengthtest { \paperwidth = 11in}}
	...
	{\ifthenelse{ \lengthtest{ \paperwidth = 297mm}}
		{\geometry{top=0.8cm,left=1.0cm,right=1.0cm,bottom=0.5cm} }
		{\geometry{top=0.8cm,left=1.0cm,right=1.0cm,bottom=0.5cm} }
	}
...
\begin{center}
     \Large{\textbf{ROS Melodic Cheatsheet}} \\
\end{center}
\newlength{\MyLen}
...
\ifcatkin
\section{ROS Melodic Catkin Workspaces}
...
\begin{nstabbing}
E\=x\=ample:\\
\> \texttt{\$ source /opt/ros/melodic/setup.bash}\\
...
\begin{flushright}
%\includegraphics[height=.12\columnwidth]{your_logo.eps}
